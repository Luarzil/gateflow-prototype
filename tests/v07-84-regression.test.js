...
const cases = [
  ...
  ["04 scanner accepts vehicle example G0001", includes(app, 'seedVehicle("veh-001", "G0001"')],
  ...
  ["22 employee IDs store E prefix", includes(app, "return legacyNumeric ? `E${legacyNumeric[1]}` : source;")],
  ...
  ["31 legacy EMP IDs migrate", includes(app, "source.match(/^(?:EMP|E)?(\\d+)$/)")],
  ...
  ["79 service worker cache version changes", includes(worker, "v0.8-patrick-issues-static")],
